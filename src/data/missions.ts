...
export const MISSIONS: Mission[] = [
  {
    id: 'mission_1',
    title: '關卡一：買蘋果牛奶 (個案初階訓練)',
    subtitle: '實地演練最愛的蘋果牛奶！',
